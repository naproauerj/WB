...
file_path = "../04_FILTRAGEM/selecao_BAHIA.xlsx" ##  "  # Altere para o caminho correto
...
for model in modelos:
    ...
    # plota
    plota_interp(grid_x,grid_y,z,16,'coolwarm',obs_longitudes,obs_latitudes,values_to_interpolate,"Media","interp_clima_krigging_"+model,"Krigging "+model)
