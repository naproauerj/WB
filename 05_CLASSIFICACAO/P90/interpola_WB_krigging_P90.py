...
datasets = [
    ("../../04_FILTRAGEM/selecao_BAHIA.xlsx", "bahia_P90_inventario.pptx", "bahia_inventario_"),
    ("../../04_FILTRAGEM/selecao_BAHIA_1981a2010.xlsx", "bahia_P90_1981a2010.pptx", "bahia_1981a2010_"),
    ("../../04_FILTRAGEM/selecao_BAHIA_1991a2020.xlsx", "bahia_P90_1991a2020.pptx", "bahia_1991a2020_"),
]

for file_path, arquivo_pptx, prefixo_imagem in datasets:
    df = pd.read_excel(file_path, sheet_name="ANUAL")
    olat, olon, valores = df["Latitude"], df["Longitude"], df["P90 NZ"]
