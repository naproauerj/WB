...
#intervals=[300,400,500,600,700,800,900,1100,2600]

# Opção 1: Deixar o algoritmo escolher os intervalos e usar a média anual
realizar_classificacao(file_path, sheet_name,coluna_variavel="Média mm/ano", case="ANUAL_MEDIA", shapefile_path = shapefile_path,cmap=escala_de_cores)
